...
public class 값이정해져있는경우 {
	...
	public static void main(String[] args) { // String[] args : String배열
		// TODO Auto-generated method stub
		//저장공간이 만들어지는 순간 저장할 값이 정해지지 않는경우
		//일단, 공간을 먼저 만들어준다
		int[] jumsu = new int[10];// index : []
		//나중에 값을 집어 넣는 경우
		jumsu[0] = 100;
		jumsu[9] = 200;
...
//		}
		//foreach: 배열의 첫위치값부터 하나씩 오른쪽으로 가면서 자동으로
...
//		int[] jumsu2 = { 100 , 200 , 300 };//공간만들면서 값을 바로 넣음
//		
