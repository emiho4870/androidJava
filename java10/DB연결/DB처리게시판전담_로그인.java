...
public class DB처리게시판전담_로그인 {
	//DB처리하는 방법이 4단계로 정해져 있다

	
	  public void create( int member_no1 , String name , String address ,int tel_no1 ,String gender ) throws ClassNotFoundException, SQLException {
	//public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		//db연동 index는 1부터 시작
		String sql = "insert into shop_member values ( ? , ? , ? , ? , ? )"; //id값 달리해서 추가됨 // auto increment : null
		//String sql = "insert into shop_member values ( null , ? , ? , ? )"; //id값 달리해서 추가됨 // auto increment : null
		...
		//ps.setString( 1 ,  );
		ps.setString( 1 , member_no1 +""); // 순번 재설정
		ps.setString( 2 , name );
