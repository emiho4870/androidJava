			...
			success :function(result){
				...
				if (list.length > 0) {
					$(list).each(function(index , news3) {
						...
						console.log(link)
						total = "<b><a href=" + link + ">"  + title + "</a></b> : " + pubDate + "<br>" + discription + "<br>" + thumbnail + "<br>" + link
                   $('#d1').append(total + "<hr>")
...
<button id= "b3" style=background:green>한경포토 db 연결</button>
<hr color="red">
<div id="d1"></div>
